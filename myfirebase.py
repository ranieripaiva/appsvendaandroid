...
class MyFirebase():
    API_KEY = "AIzaSyAJ4oOFZH6F6j02GYZwnv9FLrJ28Mmbr-4"
    ...
    def criar_conta(self, email, senha):
        ...
        if requisicao.ok:
            ...
            req_id = requests.get(f"https://aplicativovendashash-4a872-default-rtdb.firebaseio.com/proximo_id_vendedor.json?auth={id_token}")
            id_vendedor = req_id.json()

            link = f"https://aplicativovendashash-4a872-default-rtdb.firebaseio.com/{local_id}.json?auth={id_token}"
            ...
            requests.patch(f"https://aplicativovendashash-4a872-default-rtdb.firebaseio.com/.json?auth={id_token}",data=info_id_vendedor)
